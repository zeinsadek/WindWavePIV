...
tst = linspace(-1, 1, 50);
P = plot(tst, -0.07 * cos(2 * pi * (tst - (p + 1)/4)) + 0.17, 'color', 'black', ...
         'linewidth', lw, 'linestyle', ':', 'HandleVisibility', 'off');
P.Color(4) = 0.5;
...
ylabel('$\delta^* / \delta$', 'interpreter', 'latex', 'fontsize', labelFontSize)
legend('interpreter', 'latex', 'fontsize', 10, 'location',  'eastoutside', 'box', 'off', 'fontsize', legendFontSize)


% Name figure
figure_name = 'CollapsedProfiles_CurvilinearCollapseParameter.pdf';
