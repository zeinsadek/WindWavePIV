...
text(0.25, 0.92, ['$\rho = ' num2str(corr_val,'%.4f') '$'], 'FontSize', annotationFontSize, 'FontWeight', 'bold', ...
    'Interpreter', 'latex', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', 'Units', 'normalized');
text(0.25, 0.82, ['$e = ' num2str(e2,'%.4f') '$'], 'FontSize', annotationFontSize, 'FontWeight', 'bold', ...
    'Interpreter', 'latex', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', 'Units', 'normalized');
