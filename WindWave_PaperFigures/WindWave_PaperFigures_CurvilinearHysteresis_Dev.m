...
%% Compute mean boundary layer thicknesses ahead of time
...
for w = 1:length(waves)
    ...
    for s = 1:length(wind_speeds)
       ...
       mean_BL_thickness = mean(tmp, 'all', 'omitnan');

       % Save
       mean_BL_thicknesses.(caze) = mean_BL_thickness;
    end
end
