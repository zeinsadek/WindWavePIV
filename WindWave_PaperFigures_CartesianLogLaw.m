...
for p = 1:4
    ...
    P.Color(4) = 0.5;
    scatter(ens_y_plus, ens_u_plus - deltaU, sz, 'filled', 'HandleVisibility', 'on', 'MarkerFaceColor', 'black', 'MarkerFaceAlpha', 0.5, 'displayname', 'No Waves');
...
% Save figure
figure_name = ['LogLaw_Cartesian_WT', wind, '_Profiles.pdf'];
pause(3)
